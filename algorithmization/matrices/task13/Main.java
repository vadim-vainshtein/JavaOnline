/*
 * Задача 13: Отсортировать столбцы матрицы по возрастанию и убыванию значений
 */
 
/*
 * Использование: task13.Main rows columns;
 * rows, columns - количество строк и столбцов матрицы
 */

 package algorithmization.matrices.task13;
 ...
 public class Main {
 	...
 	public static void main(String[] args) {
		...
		Matrix.sortColumns(m);
		
		System.out.println("\nSorted asсending:");
		Matrix.print(m);
		
		Matrix.sortColumnsDown(m);
